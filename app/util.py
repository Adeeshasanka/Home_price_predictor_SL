...
def load_saved_artifacts():
    ...
    with open(r"F:\ML_tutorials\Project1.Real_state_price_predictor\app\Artifacts\columns.json", "r") as f:
    ...
    with open(r"F:\ML_tutorials\Project1.Real_state_price_predictor\app\Artifacts\Sri_Lankan_homePrices.pickle", "rb") as f:
